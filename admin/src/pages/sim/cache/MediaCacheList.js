...
import { deleteMediaCacheAPI } from '../../../service/sim/sim.cache.service';
// sections
...
import CacheListToolbar from '../../../sections/sim/cache/CacheListToolbar';
import { getMediaCaches } from '../../../redux/slices/sim/sim.cache';
        ...
        <HeaderBreadcrumbs
          ...
          links={[
            { name: translate('menu.dashboard'), href: PATH_DASHBOARD.root },
            {
              ...
              href: PATH_DASHBOARD.sim.caches,
            },
                        ...
                        {TABLE_HEAD.map(head => {
                          ...
                          if (head.id === '')
                            return <TableCell align="right" key={head.id}>
                              <DataGridMoreMenu pathEdit={`${PATH_DASHBOARD.sim.root}/cache/${id}/keys`}
                                pathView={`${PATH_DASHBOARD.sim.root}/cache/${id}/keys`} onDelete={() => handleDeleteItem(id)} />
                            </TableCell>;
