...
import { getMediaUserByIdAPI, searchUserAPI } from '../../../service/sim/sim.user.service';
// utils
...
export function getMediaUsers() {
  return async (dispatch, getState) => {
    ...
    const resp = await searchUserAPI({ ...mediaUser.search, value: `%${mediaUser.search.value}%` });
